...
function selectTemplate (data) {
    tb.elDlg.innerHTML = 
        ...
        '<input type="checkbox" class="cbFilter" id="cb3" name="cb3" data-op="onDlgSelectTemplateFlt" data-id="3" value="Research Note"' + (data=="Research Note" ? ' checked' : '') + '><label for="cb3"> Research Note</label><br>' +
        ...
        '<label for="flt1">Filter: </label><input type="text" class="cbFilter" id="flt1" name="flt1" data-op="onDlgSelectTemplateFlt" data-id="5"><br>' +
