...
export async function getCitation(link) {
  ...
  // Find a Grave memorials used to be fetched and parsed in-browser via a hidden background tab.
  // That was retired in 4ee4eddd ("The fetch is being blocked by the site") because Find a Grave's
  // bot protection blocks it, so these links now go to the citation service like any other.
