export const entities = {
  ...
  "France/Italy (please add county behind region and don't use it like that in the category name!)": ["Marche"],
  "France/United States (please add county behind region and don't use it like that in the category name!)": ["Maine"],
  "France/Belgium (please add county behind region and don't use it like that in the category name!)": ["Flanders"],
  "France/historical territory (please don't use it like this in the category name, but turn it into 'Savoie, France' or 'Duchy or Savoy'!)":
    ["Savoie"],

  "Please use Flanders instead": ["Hainaut"],
  "Please use Lorraine instead": ["Barrois"],
  "Please use Gascony instead": ["Foix"],

  France: [
    /* historical provices, departements below */
    "Alsace",
    "Angoumois",
    "Anjou",
    "Artois",
  ...
  "For legacy reasons, please use just 'Lippe' instead in the name of this category": [
    "Principality of Lippe",
    "Principality of Lippe-Detmold",
    "Principality of Schaumburg-Lippe",
  ],
  "For legacy reasons, please use just 'Württemberg' instead in the name of this category": ["Kingdom of Württemberg"],
  "German Empire": [
