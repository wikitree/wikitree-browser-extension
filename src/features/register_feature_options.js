...
import {
  ...
  isWikiEdit,
  isWikiHistory,
  isWikiPage /* eslint-enable no-unused-vars */,
} from "../core/pageType";
...
import "./hide_photo_column/hide_photo_column_options";
...
registerFeature({
  name: "Enumerate Image Detail",
  id: "enumerateImageDetail",
  description: 'Sort and number the list of "In this image" items on an Image page.',
  category: "Other",
  creators: [{ name: "Riël Smit", wikitreeid: "Smit-641" }],
  contributors: [],
  defaultValue: false,
  pages: [isImagePage],
});
