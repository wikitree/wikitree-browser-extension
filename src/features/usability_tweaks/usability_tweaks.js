...
checkIfFeatureEnabled("activityFeedFilters").then((isEnabled) => {
  if (isEnabled) {
    if (isNetworkFeed && trusted.includes(getUserWtId()) && window.location.href.match(/pre1700|pre1500|merge=1/)) {
      initBioCheck();
