...
function doDarkMode() {
  ...
  $("img[src*='wikitree-logo.png']").attr("src", chrome.runtime.getURL("images/wikitree-logo-white.png"));
  $("img[src*='wikitree-small.png']").attr("src", chrome.runtime.getURL("images/wikitree-logo-small-white.png"));
  $("img[src*='Wiki-Tree.gif']").attr("src", chrome.runtime.getURL("images/wikitree-logo-white-G2G.png"));
  $("img[src*='G2G.gif']").attr("src", chrome.runtime.getURL("images/G2G-transparent.png"));
  ...
  if (window.location.href.match("Special:MergePerson")) {
    setTimeout(function () {
      ...
      iframes.forEach(function (frame) {
        ...
        if (logo) {
          logo.setAttribute("src", chrome.runtime.getURL("images/wikitree-logo-small-white.png"));
        }
      });
    }, 700);
  }
