		...
		button: "Templates", items: [
			...
			{ featureid: "wtplus", title: "Add any template", call: wtPlus, params: { action: "AddTemplate" } },
			{
				title: "Category templates", items: [
					...
					{ featureid: "wtplus", title: "Geographic Location", call: wtPlus, params: { template: "Geographic Location" } }
				]
			},
		...
		button: "CIB", items: [
			...
			{ featureid: "wtplus", title: "Add any CIB", call: wtPlus, params: { action: "AddTemplate", data: "CategoryInfoBox" } },
			{
				title: "Cemeteries", items: [
					{ featureid: "wtplus", title: "Cemetery", call: wtPlus, params: { template: "CategoryInfoBox Cemetery" } },
					{ featureid: "wtplus", title: "Cemetery Group", call: wtPlus, params: { template: "CategoryInfoBox CemeteryGroup" } }
				]
			},
			{
				title: "Religion", items: [
					{ featureid: "wtplus", title: "Religious Institution Group", call: wtPlus, params: { template: "CategoryInfoBox ReligiousInstitutionGroup" } }
				]
			},
			{
				title: "Maintenance", items: [
					{ featureid: "wtplus", title: "Maintenance", call: wtPlus, params: { template: "CategoryInfoBox Maintenance" } },
					{ featureid: "wtplus", title: "Needs", call: wtPlus, params: { template: "CategoryInfoBox Needs" } },
					{ featureid: "wtplus", title: "Needs GEDCOM Cleanup", call: wtPlus, params: { template: "CategoryInfoBox NeedsGEDCOMCleanup" } },
					{ featureid: "wtplus", title: "Unconnected", call: wtPlus, params: { template: "CategoryInfoBox Unconnected" } },
			...
			},
			{
				title: "Others", items: [
					...
					{ featureid: "wtplus", title: "One Name Study", call: wtPlus, params: { template: "CategoryInfoBox OneNameStudy" } },
					{ featureid: "wtplus", title: "One Place Study", call: wtPlus, params: { template: "CategoryInfoBox OnePlaceStudy" } },
